...
# load the existing model fits
Jtu_z1i_fs_matrix <- brm(bf(repl ~ cl10ra*Matrix.category + 
                              (cl10ra | dataset_label / pair_group), 
                            zoi ~ cl10ra*Matrix.category + 
                              (cl10ra | dataset_label / pair_group), 
                            coi ~ cl10ra*Matrix.category + 
                              (cl10ra | dataset_label / pair_group),
...
Jtu_z1i_fs_taxa <- brm(bf(repl ~ cl10ra*taxa + 
                              (cl10ra | dataset_label / pair_group), 
                            zoi ~ cl10ra*taxa + 
                              (cl10ra | dataset_label / pair_group), 
                            coi ~ cl10ra*taxa + 
...
Jtu_z1i_fs_tsf <- brm(bf(repl ~ cl10ra*time.since.fragmentation + 
                            (cl10ra | dataset_label / pair_group), 
                          zoi ~ cl10ra*time.since.fragmentation + 
                            (cl10ra | dataset_label / pair_group), 
                          coi ~ cl10ra*time.since.fragmentation + 
                            (cl10ra | dataset_label / pair_group),
                          family = zero_one_inflated_beta()),
                       data = frag_beta %>% 
                         filter(method=='Baselga family, Jaccard'),
...
Jtu_z1i_fs_biome <- brm(bf(repl ~ cl10ra*biome + 
                           (cl10ra | dataset_label / pair_group), 
                         zoi ~ cl10ra*biome + 
                           (cl10ra | dataset_label / pair_group), 
                         coi ~ cl10ra*biome + 
